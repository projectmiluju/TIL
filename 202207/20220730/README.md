...
### 이진검색 Binary Search
>정렬된 배열에서 검색 범위를 줄여 나가며 검색 값을 찾는 알고리즘
...
> 2-3. 중간 값보다 검색 값이 작다면 중간갑 기준 배열의 왼쪼 구간을 탐색합니다.
...
#### 퀵정렬 시간복잡도
<img src="https://gmlwjd9405.github.io/images/algorithm-quick-sort/sort-time-complexity-etc1.png" width="1000" alt="퀵정렬"></img>
